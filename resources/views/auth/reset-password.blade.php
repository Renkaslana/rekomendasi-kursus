            ...
            <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                ...
                <div class="relative">
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <x-text-input id="email" class="block mt-1 w-full pl-10 form-input" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" readonly />
                    </div>
                ...
                <div class="relative" x-data="{ show: false }">
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input id="password"
                            class="block mt-1 w-full pl-10 pr-10 form-input"
                ...
                <div>
                    <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition transform hover:scale-[1.02] duration-200">
                        {{ __('Reset Password') }}
                    </button>
                </div>
            </form>
